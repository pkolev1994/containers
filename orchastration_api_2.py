...
def get_obj_instances():
	...
	return (DecisionMaker(), \
			SwarmManagment(), \
			ContainerManagement(), \
			Logger(filename = "orchestrator", logger_name="Orchestrator API"), \
			EtcdManagement())
...
def main():
	...
	_, _, _, _, etcd_manager = get_obj_instances()
...
############## 2018.11.07 microplatform cutting logic for stats
	...
	while True:
		decision_maker, swarm_manager, container_manager, logger, etcd_manager = get_obj_instances()
